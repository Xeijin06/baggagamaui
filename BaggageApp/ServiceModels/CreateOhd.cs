...
namespace BaggageApp.ServiceModels
{
    ...
    {
        public CategoriaSel CategoriaSel { get; set; }
    ...
    public class BagFileInput
    {
        ...
        public List<PassengerOHD> Passengers { get; set; }
        public List<Bag> Bags { get; set; }
        public List<FlightOHD> Flights { get; set; }
    ...
    public class CreateOhd
    {
        public BagFileInput bagFileInput { get; set; }
